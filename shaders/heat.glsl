...
// Heat Equation specific settings
uniform float alpha;
...
// Accesses the value of the grid at a coordinate while respecting value-based boundary conditions
float U(int x, int y) {
...
// Computes the temporal derivative at a coordinate points in the grid
